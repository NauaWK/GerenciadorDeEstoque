...
public class ProdutoController {
    ...
    public ResponseEntity<ProdutoResponseDTO> updateProduct(@PathVariable Long id, @Valid @RequestBody ProdutoRequestDTO produtoRequest){
        return produtoServices.updateProduct(id, produtoRequest);
    }  
